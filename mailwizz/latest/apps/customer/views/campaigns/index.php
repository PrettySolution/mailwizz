...
if ($viewCollection->renderContent) {
        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $campaign, 'columns' => array('campaign_id', 'campaign_uid', 'name', 'type', 'group_id', 'list_id', 'segment_id', 'search_recurring', 'status', 'send_at', 'search_template_name', 'gridViewSent', 'gridViewDelivered', 'gridViewOpens', 'gridViewClicks', 'gridViewBounces', 'gridViewUnsubs')), true), $itemsCount)
                    ...
                    ->add(CHtml::link(IconHelper::make('import') . Yii::t('app', 'Import from share code'), '#campaign-share-code-import-modal', array('class' => 'btn btn-primary btn-flat', 'data-toggle' => 'modal', 'title' => Yii::t('app', 'Import from share code'))))
     ...
     * @since 1.7.6
     */
    $this->renderPartial('_campaign_share_code_import');
    ?>
