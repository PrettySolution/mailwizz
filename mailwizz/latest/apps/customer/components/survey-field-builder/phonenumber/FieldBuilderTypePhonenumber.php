...
class FieldBuilderTypePhonenumber extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.survey-field-builder.phonenumber.behaviors.FieldBuilderTypePhonenumber';
        ...
        // register assets
        Yii::app()->clientScript->registerCssFile(Yii::app()->apps->getAppUrl('frontend', 'assets/js/intl-tel-input/css/intlTelInput.css', false, true));
        Yii::app()->clientScript->registerScriptFile(Yii::app()->apps->getAppUrl('frontend', 'assets/js/intl-tel-input/js/intlTelInput-jquery.js', false, true));
