                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        array(
                            'name'  => 'screenshot',
                            'type'  => 'raw',
                            'value' => 'CHtml::link(CHtml::image($data->getScreenshotSrc(), "", array("class" => "img-round", "width" => 120)), Yii::app()->createUrl(\'email_templates_gallery/preview\', array(\'template_uid\' => $data->template_uid)), array("class" => "preview-email-template", "title" => Yii::t("email_templates", "Preview") . " " . $data->name))',
                            'filter'=> false,
                        ),
                        array(
                            'name'  => 'name',
