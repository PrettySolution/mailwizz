    ...
    if ($collection->renderForm) {
        ...
        <div class="box box-primary borderless">
            <div class="box-header">
                <h3 class="box-title"><?php echo IconHelper::make('fa-cog') . Yii::t('settings', 'Webhooks')?></h3>
            </div>
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
	                        <?php echo CHtml::link(IconHelper::make('info'), '#page-info-webhooks', array('class' => 'btn btn-primary btn-xs btn-flat', 'title' => Yii::t('app', 'Info'), 'data-toggle' => 'modal'));?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
					<?php echo Yii::t('settings', 'Please note that in order for the campaign webhook requests to be sent, you need to add the following cron job, which runs once at 2 minutes:');?><br />
