        ...
        <?php foreach ($server->conditions as $index => $cond) {?>
            <div class="item">
                ...
                <div class="col-lg-2 select-campaign-group-wrapper" style="display: <?php echo !empty($cond['campaign_group_id']) ? 'block' : 'none'; ?>">
		            <?php echo CHtml::label(Yii::t('servers', 'Campaign group'), 'campaign_group_id');?>
		            <?php echo CHtml::dropDownList($server->modelName . '[conditions]['.$index.'][campaign_group_id]', $cond['campaign_group_id'], $server->getCustomerCampaignGroupsAsOptions(), $server->getHtmlOptions('conditions')); ?>
                </div>
                <div class="col-lg-2">
...
<div id="condition-template" style="display: none;">
    <div class="item">
        ...
        <div class="col-lg-2 select-campaign-group-wrapper" style="display: none">
		    <?php echo CHtml::label(Yii::t('servers', 'Campaign group'), 'list_id');?>
		    <?php echo CHtml::dropDownList($server->modelName . '[conditions][{index}][campaign_group_id]', '', $server->getCustomerCampaignGroupsAsOptions(), $server->getHtmlOptions('conditions')); ?>
        </div>
        <div class="col-lg-2">
            <label><?php echo Yii::t('app', 'Action');?></label><br />
            <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-condition"><?php echo IconHelper::make('delete');?></a>
