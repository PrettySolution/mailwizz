...
if ($viewCollection->renderContent) { ?>
    <div class="table-responsive responders-table">
        <div class="pull-right">
            <span class="counter">
                <?php echo Yii::t('survey_responders', 'Found {count} responders.', array('{count}' => Yii::app()->format->formatNumber($count) ));?>
            </span>
        </div>
        <div class="clearfix"><!-- --></div>
        <?php echo CHtml::form('', 'post', array('id' => 'responders-form'));?>
            ...
            <tbody>
                <tr>
                    <td colspan="<?php echo count($columns);?>" align="center">
                        <?php echo Yii::t('survey_responders', 'Sorry, but there are no responders to show right now.');?>
                    </td>
                </tr>
            </tbody>
            <?php } ?>
        </table>
        <?php echo CHtml::submitButton('submit', array('name' => 'do', 'style' => 'display:none', 'id' => 'submit-respond-form'));?>
    ...
    <div class="row-fluid">
        <div class="pull-right">
            <?php $this->widget('CLinkPager', array(
                'pages'         => $pages,
                'htmlOptions'   => array('id' => 'responders-pagination', 'class' => 'pagination'),
                'header'        => false,
                'cssFile'       => false                    
            )); ?>
        </div>
