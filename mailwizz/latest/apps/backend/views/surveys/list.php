        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $survey, 'columns' => array('survey_uid', 'customer_id', 'display_name', 'responders_count', 'last_updated')), true), $itemsCount)
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('surveys/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
            </div>
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'value'     => 'Yii::app()->format->formatNumber($data->respondersCount)',
                            'filter'    => false,
                            'sortable'  => false,
                        ),
                        array(
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'confirm_delete' => array(
                                    ...
                                    'visible'   => 'AccessHelper::hasRouteAccess("surveys/delete") && $data->isRemovable',
                                ),
                            ),
