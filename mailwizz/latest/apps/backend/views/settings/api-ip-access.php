...
if ($viewCollection->renderContent) { ?>
    <ul class="nav nav-tabs" style="border-bottom: 0px;">
        <li class="inactive"><a href="<?php echo $this->createUrl('settings/api')?>"><?php echo CHtml::encode(Yii::t('settings', 'Common'));?></a></li>
        <li class="active"><a href="<?php echo $this->createUrl('settings/api_ip_access')?>"><?php echo CHtml::encode(Yii::t('settings', 'Ip access'));?></a></li>
    </ul>
    <?php
    /**
