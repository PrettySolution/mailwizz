                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown tasks-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="javascript:;" class="header-account-stats-refresh"><?php echo IconHelper::make('refresh') . Yii::t('app', 'Refresh');?></a>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <?php } else { 
                    $hooks->doAction('customer_layout_main_sidebar_user_panel', $this);
                } ?>
            </div>
