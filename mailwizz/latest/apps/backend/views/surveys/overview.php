                ...
                <div class="col-lg-4 col-xs-4">
                    <div class="small-box">
                        <div class="inner">
                            <div class="middle">
                                <h6>&nbsp;</h6>
                                <h3><?php echo CHtml::link(Yii::app()->format->formatNumber($respondersCount), 'javascript:;', array('title' => Yii::t('survey_responders', 'Responders')));?></h3>
                ...
                <div class="col-lg-4 col-xs-4">
                    <div class="small-box">
                        <div class="inner">
                            <div class="middle">
                                <h6>&nbsp;</h6>
                                <h3><?php echo CHtml::link(Yii::app()->format->formatNumber($customFieldsCount), 'javascript:;', array('title' => Yii::t('survey_fields', 'Custom fields')));?></h3>
