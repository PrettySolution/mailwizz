        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(CHtml::link(IconHelper::make('fa-check-square') . Yii::t('app', 'Mark all as seen'), array('messages/mark_all_as_seen'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Mark all as seen'))))
                    ->add(HtmlHelper::accessLink(IconHelper::make('refresh') . Yii::t('app', 'Refresh'), array('messages/index'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Refresh'))))
                    ->render();
                ?>
            </div>
