...
class FieldBuilderTypeDateCrud extends CBehavior
{
	...
	public function _addAttributeHelpTexts(CEvent $event)
	{
		...
		$text = Yii::t('list_fields', 'In case this field is not required and you need a default value for it. The format must be "Y-m-d". Following tags are recognized: {tags}', array('{tags}' => $tags));
