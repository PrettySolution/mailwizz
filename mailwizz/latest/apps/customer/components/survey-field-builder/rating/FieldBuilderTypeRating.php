...
class FieldBuilderTypeRating extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.survey-field-builder.rating.behaviors.FieldBuilderTypeRating';
        ...
        Yii::app()->clientScript->registerScriptFile(Yii::app()->apps->getAppUrl('frontend', 'assets/js/bootstrap-rating-input/bootstrap-rating-input.min.js', false, true));
