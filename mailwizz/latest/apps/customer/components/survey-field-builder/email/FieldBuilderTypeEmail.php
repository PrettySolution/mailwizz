...
class FieldBuilderTypeEmail extends FieldBuilderType
{
    public function run()
    {
        $apps       = Yii::app()->apps;
        $hooks      = Yii::app()->hooks;
        $baseAlias  = 'customer.components.survey-field-builder.email.behaviors.FieldBuilderTypeEmail';
