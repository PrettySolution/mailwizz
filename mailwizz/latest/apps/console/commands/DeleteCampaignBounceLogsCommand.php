...
class DeleteCampaignBounceLogsCommand extends ConsoleCommand
{
    ...
    {
        $daysBack        = (int)Yii::app()->params['campaign.bounce.logs.delete.days_back'];
        $campaignsAtOnce = (int)Yii::app()->params['campaign.bounce.logs.delete.process_campaigns_at_once'];
        $logsAtOnce      = (int)Yii::app()->params['campaign.bounce.logs.delete.process_logs_at_once'];
