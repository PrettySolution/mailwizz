                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <br /><br />
                            <?php echo Yii::t('servers', 'You can configure your PostMark account webhook as seen here: {url}', array(
                                '{url}' => CHtml::link('https://postmarkapp.com/support/article/1067-how-do-i-enable-delivery-webhooks', 'https://postmarkapp.com/support/article/1067-how-do-i-enable-delivery-webhooks', array('target' => '_blank')),
                            ));?>
                            <br /><br />
                            <?php echo Yii::t('servers', 'Make sure you enable Bounce and Spam Complaint events, including the above webhook url.');?>
                        </div>
                    </div>
                </div>
            </div>
