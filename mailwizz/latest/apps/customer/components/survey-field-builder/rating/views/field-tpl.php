...
<div class="field-row" data-start-index="<?php echo $index;?>" data-field-type="<?php echo $model->type->identifier;?>">
    ...
    <ul class="nav nav-tabs">
        <li class="active">
            <a href="javascript:;"><span class="glyphicon glyphicon-th-list"></span> <?php echo Yii::t('survey_fields', 'Rating field');?></a>
        </li>
    </ul>
    <div class="panel panel-default no-top-border">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php echo CHtml::textField($model->modelName.'['.$fieldType->identifier.']['.$index.'][max_stars]', $model->max_stars, $model->getHtmlOptions('max_stars')); ?>
        ...
        <div class="panel-footer">
            <div class="pull-right">
                <a href="javascript:;" class="btn btn-danger btn-flat btn-remove-rating-field" data-field-id="<?php echo (int)$model->field_id;?>" data-message="<?php echo Yii::t('survey_fields', 'Are you sure you want to remove this field? There is no coming back from this after you save the changes.');?>"><?php echo IconHelper::make('delete');?></a>
            </div>
